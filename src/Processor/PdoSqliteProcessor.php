...
class PdoSqliteProcessor implements ProcessorInterface
{
    /**
    ...
    /**
     * Create a new PdoSqliteProcessor.
     *
    ...
    public function __construct(
        ...
        $this->storage = $storage ?: new PdoSqliteStorage();
        $this->grammar = new PdoSqliteGrammar();
    }
